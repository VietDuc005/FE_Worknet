...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.password !== formData.confirmPassword) {
      showToast("Mật khẩu không khớp", "success");
      return
    }
    setIsLoading(true)
    setTimeout(() => {
      showToast(`Đang đăng ký: ${formData.email}`, "success");
      setIsLoading(false)
    }, 500)
  }
  ...
  <div className="text-center mb-6">
    <h2 className="text-xl font-semibold text-foreground">Đăng ký tài khoản của bạn</h2>
  </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-muted-foreground">Hoặc đăng ký bằng google</span>
          </div>
        </div>
